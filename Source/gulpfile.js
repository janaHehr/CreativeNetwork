...
gulp.task('index', function () {
    return gulp.src(publicSrcDir + 'index.html')
        .pipe(plugins.inject(gulp.src([jsDistPath + combinedJsDistFile, cssDistPath + cssDistFile], {read: false}), {ignorePath: '/dist/public', addRootSlash: false}))
...
gulp.task('index:dev', function () {
    return gulp.src(publicSrcDir + 'index.html')
        .pipe(plugins.inject(gulp.src(jsDistFiles.concat([cssDistPath + cssDistFile]), {read: false}), {ignorePath: '/dist/public', addRootSlash: false}))
        .pipe(gulp.dest(publicDistPath));
});
